...
config.emb_size = 1024
config.ckpt_embedding = True
config.net_se = 1
config.net_act = 'prelu'
config.net_unit = 3
config.net_input = 3  # defult: 1, STN: 3
...
dataset.emore.dataset_path = '/data/face/datasets/smg'
dataset.emore.num_classes = 50000
#  dataset.emore.num_classes = 5709
#  dataset.emore.image_shape = (112,112,3)
dataset.emore.image_shape = (128,112,3) #w, h, c
...
dataset.retina.num_classes = 93431 # 5272942 images
dataset.retina.image_shape = (112,128,3)
...
loss.combined.loss_m2 = 0.5
loss.combined.loss_m3 = 0.0
...
# default network
default.network = 'r34'
#  default.pretrained = './models/pretrained/model'
#  default.pretrained_epoch = 55
default.pretrained = ''
...
default.wd = 0.0005
default.mom = 0.9
default.per_batch_size = 80
default.ckpt = 2
default.lr_steps = '100000,160000,220000'
default.models_root = './models/0102'
