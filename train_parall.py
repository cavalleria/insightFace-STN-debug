...
def train_net(args):
    ...
    if len(args.pretrained)==0:
      ...
      print('load pretrained model {}, epoch is {}'.format(args.pretrained, args.pretrained_epoch))
      esym = get_symbol_embedding()
      asym = get_symbol_arcface
      _, arg_params, aux_params = mx.model.load_checkpoint(args.pretrained, args.pretrained_epoch)
      #  print('debug aux params: ', aux_params)
      #  print('debug arg params: ', arg_params)
      #  assert False
    ...
    def ver_test(nbatch):
      ...
      for i in range(len(ver_list)):
        ...
        acc1, std1, acc2, std2, xnorm, embeddings_list = verification.test(ver_list[i], model, 32, 10, None, None)
